...
type ServerInterface interface {
	...
	// (GET /api/traces/{timestamp})
	GetTracesAfterTimestamp(w http.ResponseWriter, r *http.Request, timestamp int64)
}
...
// GetTracesAfterTimestamp operation middleware
func (siw *ServerInterfaceWrapper) GetTracesAfterTimestamp(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetTracesAfterTimestamp(w, r, timestamp)
	}))
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/traces", wrapper.GetTraces)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/traces/{timestamp}", wrapper.GetTracesAfterTimestamp)
